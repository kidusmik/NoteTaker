...
public final class NoteTakerContentProviderContract {
    private NoteTakerContentProviderContract(){}

    public static final String AUTHORITY = "com.kidus.notetaker.provider";
